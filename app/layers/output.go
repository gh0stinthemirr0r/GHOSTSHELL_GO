...
func WriteOutput(results []TestResult, format string, outputPath string) error {
...
func writeCSV(results []TestResult, outputPath string, logger *zap.Logger) error {
...
func writePDF(results []TestResult, outputPath string, logger *zap.Logger) error {
...
func writeJSON(results []TestResult, outputPath string, logger *zap.Logger) error {
	file, err := os.Create(outputPath)
	if err != nil {
