...
// Matches checks if a URL matches the include/exclude patterns and depth criteria.
...
func NewFilter(includePatterns, excludePatterns []string, maxDepth int) *Filter {
	return &Filter{
